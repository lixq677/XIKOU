...
#import "CTCountdownView.h"

@implementation CTCountdownView
...
- (void)layout{
    ...
    [self.hourLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.hintLabel.mas_right).offset(7.0f);
        make.centerY.equalTo(self.hintLabel);
        make.width.height.mas_equalTo(21.0f);
    }];
    [self.colonLabel1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.hourLabel.mas_right).offset(5.0f);
    ...
    [self.minuteLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.colonLabel1.mas_right).offset(5.0f);
        make.centerY.equalTo(self.colonLabel1);
        make.width.height.mas_equalTo(21.0f);
    }];
    [self.colonLabel2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.minuteLabel.mas_right).offset(5.0f);
        make.centerY.equalTo(self.minuteLabel);
        make.width.mas_equalTo(5.0f);
        make.height.mas_equalTo(21.0f);
    }];
    [self.secondLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.colonLabel2.mas_right).offset(7.0f);
...
- (UILabel *)hourLabel{
    if (!_hourLabel) {
        ...
        _hourLabel.font = [UIFont systemFontOfSize:13.0f];
        _hourLabel.layer.cornerRadius = 10.5f;
        _hourLabel.text = @"00";
...
- (UILabel *)minuteLabel{
    if (!_minuteLabel) {
        ...
        _minuteLabel.font = [UIFont systemFontOfSize:13.0f];
        _minuteLabel.layer.cornerRadius = 10.5f;
...
- (UILabel *)secondLabel{
    if (!_secondLabel) {
        ...
        _secondLabel.font = [UIFont systemFontOfSize:13.0f];
        _secondLabel.layer.cornerRadius = 10.5f;
...
- (UILabel *)colonLabel1{
    if (!_colonLabel1) {
        ...
        _colonLabel1.font = [UIFont boldSystemFontOfSize:15.0f];
    }
    return _colonLabel1;
}
...
- (UILabel *)colonLabel2{
    if (!_colonLabel2) {
        ...
        _colonLabel2.font = [UIFont boldSystemFontOfSize:15.0f];
    }
    return _colonLabel2;
}
    @end
