...
{
    NSDateFormatter *formatter = [NSDate shareFormatter];
...
{
    NSDateFormatter *dateFormatter = [NSDate shareFormatter];
...
- (NSDate *)dateWithYMD
{
    NSDateFormatter *fmt = [NSDate shareFormatter];
...
+(NSString *) compareCurrentTime:(NSString*) compareDate
{
    ...
    if (timeInterval < 60) {
        ...
        NSDateFormatter *formatter2 = [NSDate shareFormatter];
        [formatter2 setDateFormat:@"M-dd H:mm"];
        NSDate *date2 =[formatter dateFromString:compareDate];
        result = [formatter2 stringFromDate:date2];
    }else{
        NSDateFormatter *formatter3 = [NSDate shareFormatter];
        [formatter3 setDateFormat:@"yyyy-M-dd H:mm"];
        NSDate *date3 =[formatter dateFromString:compareDate];
        result = [formatter3 stringFromDate:date3];
    }
    return  result;
}
