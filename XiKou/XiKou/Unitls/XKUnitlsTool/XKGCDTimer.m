...
//  XiKou
//
//  Created by L.O.U on 2019/8/2.
//  Copyright © 2019 李笑清. All rights reserved.
//

#import "XKGCDTimer.h"

@interface XKGCDTimer ()
...
@implementation XKGCDTimer

#pragma mark - Public Method

// 单例
+ (XKGCDTimer *)sharedInstance
{
    static XKGCDTimer *_XKGCDTimer = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken,^{
        _XKGCDTimer = [[XKGCDTimer alloc] init];
    });
...
{
    if (timerName.length == 0 || !timerName)
        return;
